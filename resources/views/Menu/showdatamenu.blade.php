...
<head>
    <title>AdminLTE 3 | Edit Data Menu</title>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                       <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <form action="/updatedatamenu/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                      ...
                                      <input type="text" name="nama_menu" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $data->nama_menu}}">
                                    </div>
                                    <div class="mb-3">
