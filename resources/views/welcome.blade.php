...
<head>
    ...
    <title>AdminLte 3 | Cafebon</title>
    <!-- Favicon-->
    ...
    <link href="{{asset('homelanding/css/styles.css')}}" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Welcome To Aplication Coffee Shop!</div>
            <div class="masthead-heading text-uppercase">CAFEBON</div>
    ...
    <!-- <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; Aplikasi COffe Shop 2021</div>
    ...
    <!-- Core theme JS-->
    <script src="{{asset('homelanding/js/scripts.js') }}"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
